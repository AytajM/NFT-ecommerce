        ...
        <div className="connect-wallet">
          ...
          <div className="connect">
            <div className="head_c">
              ...
              <div className="btns">
                <Link className="c_btn" to="https://metamask.io/" target="blank">
                  <img
                ...
                <br />
                <Link className="c_btn" to="https://walletconnect.com/" target="blank">
                  <img
                ...
                <br />
                <Link className="c_btn" to="https://www.coinbase.com/ru/" target="blank">
                  <img
